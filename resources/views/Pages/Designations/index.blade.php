                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{trans('trans.Designations_Informations')}}</h3>
                        </div>
                        <!-- /.card-header -->
                        @if ($errors->any())
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                        ...
                                                        {{trans('trans.Update_Designation')}}
                                                    ...
                                                    <form action="{{ route('Designations.update', 'test') }}" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div class="row">
                                                            <label for="firstname" class="mr-sm-2">{{trans('trans.Name')}}
                                                                :</label>
                                                            <input id="name" type="text" name="name" class="form-control" value="{{$Designation->name}}" required>
                                                            <input id="id" type="hidden" name="id" class="form-control" value="{{$Designation->id}}">
                                                        ...
                                                        <div class="row">
                                                            <label for="name" class="mr-sm-2">{{trans('trans.Title')}}
                                                                :</label>
                                                            <textarea id="title" name="title" class="form-control">{{$Designation->title}}</textarea>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                        id="exampleModalLabel">
                                                        {{trans('trans.Delete_Designation')}}
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('Designations.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        {{trans('trans.Are_you_sure_delete')}}   <span style="    font-weight: bolder;">{{$Designation->name}} </span>?
